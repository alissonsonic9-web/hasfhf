...
export function Bonuses() {
  ...
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 bg-[#fca951] text-white">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="inline-block rounded-lg bg-white/10 px-3 py-1 text-sm font-semibold text-white">Bônus Especiais</div>
          <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl uppercase text-white">E ainda tem mais...</h2>
          ...
          {bonusItems.map((bonus, index) => (
            <div key={index} className="flex flex-col items-center text-center gap-4">
               ...
               <div className="space-y-2">
                ...
                <p className="text-lg text-white/90">{bonus.description}</p>
               </div>
            </div>
          ))}
        </div>
