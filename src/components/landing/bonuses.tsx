    ...
    <section className="w-full py-12 md:py-24 lg:py-32 bg-primary text-primary-foreground">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="inline-block rounded-lg bg-white/10 px-3 py-1 text-sm font-semibold">Bônus Especiais</div>
          <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Para garantir hoje!</h2>
        ...
        <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2 lg:gap-12">
          {bonusItems.map((bonus, index) => (
            <Card key={index} className="overflow-hidden shadow-lg bg-white/10 border-white/20 hover:shadow-white/20 transition-shadow duration-300">
              {bonus.image && (
