...
const benefits = [
  ...
  {
    icon: <Guitar className="w-8 h-8 text-accent" />,
    ...
    <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-primary">Com esse material você terá!</h2>
        ...
        <div className="mx-auto grid max-w-5xl items-start gap-6 py-12 lg:grid-cols-3 lg:gap-12">
          {benefits.map((benefit, index) => (
            <Card key={index} className="bg-card border-primary/20 shadow-lg hover:shadow-primary/20 transition-shadow duration-300">
